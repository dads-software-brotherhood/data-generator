...
import mx.infotec.dads.datafactory.AddressDataValues;
import mx.infotec.dads.datafactory.ContentDataValues;
import mx.infotec.dads.datafactory.CurpRfcDataValues;
import mx.infotec.dads.datafactory.EntidadesDataValues;
import mx.infotec.dads.datafactory.NameDataValues;
...
public final class DataFactory {
	...
	private EntidadesDataValues entidadesDataValues = new DefaultEntidadesDataValues();
	private CurpRfcDataValues curpRfcDataValues = new DefaultCurpRfcDataValues();
	...
	/**
	 * Se agregan funcionalidades RNM
	 */

	/**
	 * 
	 * @return Lista completa con los detalles de las entidades
	 */
	public List<Entidades> getEntidades() {
		return entidadesDataValues.getEntidades();
	}

	/**
	 * 
	 * @param id
	 * @return La entidad con el id que se envía con el parámetro si el id = 0
	 *         genera un random para devolver una entidad.
	 */
	public Entidades getEntidad(int id) {
		return entidadesDataValues.getEntidad(id);
	}

	/**
	 * 
	 * @param id
	 * @return Nombre de la entidad que encuentra con el id, si se pasa el id =
	 *         0, se regresa un nombre aleatorio
	 */
	public String getNombreEntidad(int id) {
		return entidadesDataValues.getNombreEntidad(id);
	}

	/**
	 * 
	 * @param id
	 * @return Abreviatura de la entidad que encuentra con el id, si se pasa el
	 *         id = 0, se regresa un nombre aleatorio
	 */
	public String getAbreviaturaEntidad(int id) {
		return entidadesDataValues.getAbreviaturaEntidad(id);
	}
	
	/**
	 * Metodo para regresar un curp de la persona
	 * @return
	 */
	public String getCurp() {
		return curpRfcDataValues.getRandomCurp();
	}
	
	/**
	 * Metodo para regresar un rfc de la persona fisica;
	 * @return
	 */
	public String getRfc() {
		return curpRfcDataValues.getRandomRfc();
	}
	
	public String getRfcMoral() {
		return curpRfcDataValues.getRandomRfcMoral();
	}
	...
	public String getZipCode() {
		String zipCode = String.format("%d%d%d%d%d", 0, random.nextInt(Constants.NUMBERS.length),
				random.nextInt(Constants.NUMBERS.length), random.nextInt(Constants.NUMBERS.length),
				random.nextInt(Constants.NUMBERS.length));
		return zipCode;
	}
